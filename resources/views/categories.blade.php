...
<body>
    ...
    <h2 class="text-2xl text-center text-gray-800 mb-6 ">Thêm Chủ Đề </h2>
    ...
    <div class="w-200">
        <h1 class="text-2xl text-blue-500">Danh sách chủ đề</h1>
        <ul class="border border-gray-200">
        <li class="p-2 font-bold">
                <ul class="flex justify-between">
                    {{-- <li class="w-30">Id</li> --}}
                    <li class="w-70">Tên chủ đề</li>
                    {{-- <li class="w-70">Tác giả</li> --}}
            ...
            <li class="even:bg-gray-200 p-2">
                <ul class="flex justify-between">
                    ...
                    <li class="w-30 flex">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="20px" fill="#000000"><path d="M312-144q-29.7 0-50.85-21.15Q240-186.3 240-216v-480h-48v-72h192v-48h192v48h192v72h-48v479.57Q720-186 698.85-165T648-144H312Zm336-552H312v480h336v-480ZM384-288h72v-336h-72v336Zm120 0h72v-336h-72v336ZM312-696v480-480Z"/></svg>
