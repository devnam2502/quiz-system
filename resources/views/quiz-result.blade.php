...
<body>
  ...
  <div class="flex flex-col min-h-screen items-center bg-gray-100">
    ...
    <div class="w-200">
        ...
        <a class="text-green-500 font-bold block" href="/certificate">Xem và download Certificate</a>
        @endif
        <h1 class="text-2xl text-green-900 text-center my-5">
            {{$correctAnswers}} trên {{count($resultData)}} Đúng</h1>
        <ul class="border border-gray-200">
        <li class="p-2 font-bold">
                <ul class="flex justify-between">
                    <li class="w-30">Id</li>
                    <li class="w-70">Câu hỏi</li>
                    <li class="w-70">Kết quả</li>
