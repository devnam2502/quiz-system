...
<body>
  ...
  <div class="flex flex-col min-h-screen items-center bg-gray-100 justify-between">
    ...
    @endif
    <h1 class="text-4xl font-bold text-green-900 p-5" >Thử thách kiến thức</h1>
    ...
    <div class="w-200">
        <h1 class="text-2xl text-green-900 text-center my-5">Các chủ đề hot</h1>
    ...
    <div class="w-200">
    <h1 class="text-2xl text-green-900 text-center my-10">Các Quiz Hot</h1>
